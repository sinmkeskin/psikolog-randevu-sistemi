...
const DoctorsPage = () => {
  ...
  useEffect(() => {
    fetch("https://psikolog-randevu-579c59e75065.herokuapp.com/getDoctors.php")
      .then((response) => {
        if (!response.ok) {
              ...
              <img
                src={
                  doctor.photo
                    ...
                    : "https://psikolog-randevu-579c59e75065.herokuapp.com/images/default.jpg" // Eğer fotoğraf yoksa varsayılan görsel
                }
                alt={doctor.name}
